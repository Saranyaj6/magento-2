<?php
namespace Codilar\ProductAttributes\Model\Import;
...
use Codilar\ProductAttributes\Setup\Patch\Data\AddProductAttribute;

/**
 * Class ProductAttributes
 */
class ProductAttributes extends AbstractEntity
{
    const ENTITY_CODE = 'productattributes';
    ...
    */
    ...
    {
        $this->productAttribute->getAttribute($rowData);
        ...
        if ($entityData) {
            ...
            foreach ($entityData as $entityRows) {
                foreach ($entityRows as $row) {
                    ...
                    $logger->info(json_encode($row, true));
                }
            }
    ...
    {
        $this->productAttribute->deleteAttribute($entityIds);
        if ($entityIds) {
            try {
